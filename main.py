...
try: app_id = int(os.environ.get("app_id", "22670179") )
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "75048a4fce71307e1ba482737929ba55")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6987260580:AAEO1xjSrL-LIEUM_OLzP7gmdNLoa4mJEIU")
...
<b>• Developer : <a href=https://t.me/+WZvF5oPnLD8wZWE1>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/+WZvF5oPnLD8wZWE1>Click Here</a></b>
...
print("Bot Created By https://t.me/+WZvF5oPnLD8wZWE1")
